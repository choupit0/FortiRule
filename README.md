...
To use the plain text files generated by FortiRule, you need to create a new External Connector and then choose the Threat Feeds connector. You'll need 2 of type "IP Address" and 2 more of type "FortiGuard Category" (tested on FortiOS 6.4 and 7.0).

An example here with the creation of the connector to block threats at the IP address level:



I always create these connectors at the "Global" level to use them later in the VDOM.
